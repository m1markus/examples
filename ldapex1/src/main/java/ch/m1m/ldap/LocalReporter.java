 ...
 */
public class LocalReporter extends ScheduledReporter {
    /**
     * Returns a new {@link Builder} for {@link LocalReporter}.
     *
     * @param registry the registry to report
     * @return a {@link Builder} instance for a {@link LocalReporter}
     */
    ...
    /**
     * A builder for {@link LocalReporter} instances. Defaults to using the default locale and
    ...
    public static class Builder {
        ...
        /**
         * Builds a {@link LocalReporter} with the given properties.
         *
         * @return a {@link LocalReporter}
         */
        public LocalReporter build() {
            return new LocalReporter(registry,
                    output,
                    locale,
                    clock,
                    timeZone,
    ...
    private LocalReporter(MetricRegistry registry,
                          PrintStream output,
                          Locale locale,
                          Clock clock,
                          TimeZone timeZone,
