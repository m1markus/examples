...
public class TokenSecuredResource {
    ...
    public String genToken() throws Exception {
        ...
        String bearerToken = TokenUtils.generateTokenString(claimsJson, timeClaims);
    ...
    @PermitAll
    @Produces(MediaType.TEXT_PLAIN)
    public String genCurl() throws Exception {
        String token = genToken();
        String curlCommand = String.format("curl -H \"Authorization: Bearer %s\" -v http://localhost:8080/secured/roles", token);
        return curlCommand;
    }
