...
public class MyCXFSoapInterceptorOne extends AbstractSoapInterceptor {
 
    public MyCXFSoapInterceptorOne() {
        super(Phase.READ);
    ...
    public void handleMessage(SoapMessage message) throws Fault {
      ...
      System.err.println("TRACE MyCXFSoapInterceptorOne:handleMessage()");
