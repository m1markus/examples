...
Using either UNIX or Windows:
  ...
  mvn clean package   (builds the demo and creates a WAR file for optional Tomcat deployment)
  mvn tomcat7:run

  mvn jetty:run

  browser url: http://localhost:8080/SoapHello/services/SoapHello?wsdl
